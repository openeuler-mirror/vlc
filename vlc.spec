...
BuildRequires:  mesa-vdpau-drivers
BuildRequires:  mesa-libglapi
BuildRequires:  mesa-filesystem
BuildRequires:  mesa-dri-drivers
BuildRequires:  gcc >= 10
BuildRequires:  gcc-c++ glibc llvm clang
...
BuildRequires:  jack-audio-connection-kit >= 1.9.7 pkgconfig(jack) 
BuildRequires:  libjpeg-devel
BuildRequires:  libmad-devel
BuildRequires:  libmatroska-devel
BuildRequires:  libogg-devel >= 1.0
BuildRequires:  opus >= 1.0.3
BuildRequires:  libraw1394 >= 2.0.1
BuildRequires:  librsvg2 >= 2.9.0
...
BuildRequires:  protobuf2-lite-devel
...
- init from openSUSE and fix for openEuler
  ...
  changes: https://build.opensuse.org/package/view_file/openSUSE:Factory:RISCV/vlc/vlc.changes
  disable openCV
  disable some codecs
  enable run as root